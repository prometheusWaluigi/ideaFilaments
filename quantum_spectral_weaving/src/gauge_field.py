...
class GaugeFieldCoupling:
    ...
    ):  # quantum stability limit fr fr
        logger.info(
            f"Initializing GaugeFieldCoupling with field_strength={field_strength}, "
    ...
    def update_coupling_field(
        ...
        logger.info(
            f"Updating coupling field with learning_rate={learning_rate}, noise_scale={noise_scale}"
        )
